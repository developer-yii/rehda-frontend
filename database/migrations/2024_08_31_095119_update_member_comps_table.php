...
return new class extends Migration
{
    ...
    {
        // for handling 0000-00-00 records in member_comps table
        DB::statement('SET SESSION sql_mode = ""');

        Schema::table('member_comps', function (Blueprint $table) {
            $table->timestamp('d_deleted_at')->nullable()->comment('Record deletion date and time')->after('d_created_at');
        });
