...
<head>
    <title>REHDA Proforma Invoice - {{ config('constant.PR_ORDERID_SET').$order->order_no }}</title>
    ...
    <div class="container">
        ...
        <table cellpadding="0" cellspacing="0" width="100%" class="header">
            <tbody>
                <tr>
                    <td class="text-left">
                        <h1 style="font-size:42px;">Proforma Invoice</h1>
                    </td>
                ...
                <tr style="background-color:#eeeeee;">
                    <td class="text-left">
                        <p>Proforma Invoice No.: <span style="font-weight:500;">{{ config('constant.PR_ORDERID_SET').$order->order_no }}</span></p>
                        <p>
                            Acc Code:
                        </p>
                    </td>
            ...
            <tbody class="table-basic-info">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <p>- {{ getMembershipNobyMID($order->memberComp->d_mid) }}</p>
                        <p>- {{ $order->memberComp->member->branch->bname ?? '' }} - {{ $order->memberComp->member->memberType->typename ?? null }}</p>
                    </td>
                    <td>
