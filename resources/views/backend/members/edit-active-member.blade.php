        ...
        <!-- Users List Table -->
            <div class="card mb-4">
                ...
                <form class="card-body addnew" method="post" enctype="multipart/form-data" name="addnew" id="addnew">
                    ...
                    <div class="row g-3 pb-3">
                        <label class="col-sm-2 col-form-label" for="status">Status<span class="required">*</span></label>
                        <div class="col-sm-10">
                            <select id="status" name="status" class="form-control">
                                <option value="1" @if ($data->d_status === 1) selected @endif>Active</option>
                                <option value="4" @if ($data->d_status === 4) selected @endif>Inactive</option>
                            </select>
                            <div class="invalid-feedback"></div>
                        </div>
                    </div>
...
@section('page-js')
    <script>
        ...
        var updateMemberUrl = "{{ route('active-members.update', ['id' => $mid]) }}";
    </script>

    <script src="{{ addPageJsLink('edit-active-member.js?v=' . assetVersion() . time()) }}"></script>
@endsection
