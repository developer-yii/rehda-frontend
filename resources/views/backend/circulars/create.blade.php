...
@section('title', 'Circulars | Create')
...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="d-flex justify-content-end">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">New Circulars</li>
                </ol>
            </nav>
        </div>
        ...
        {{-- Circular --}}
        <div class="card mb-4">
            <h5 class="card-header">New Circular</h5>
            <form class="card-body addCircular" method="post" enctype="multipart/form-data" name="addcircular"
                ...
                <div class="row g-3 pb-3">
                    ...
                    <div class="col-sm-10">
                        <div>
                            <textarea name="ar_yr" id="ar_yr" rows="15" class="form-control" placeholder="Circular Description"></textarea>
                            <div class="invalid-feedback"></div>
                        </div>
                    </div>
                </div>
...
@section('page-js')
    <script>
        var storeUrl = "{{ route('circulars.store') }}";
    </script>
    <script src="{{ addPageJsLink('add-circular.js?v=' . assetVersion() . time()) }}"></script>
