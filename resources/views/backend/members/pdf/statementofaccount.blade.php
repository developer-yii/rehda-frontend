                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        ...
                                        <p>{{ config('constant.COMPANY_ADDRESS') }}<br>{{ config('constant.COMPANY_ADDRESS1') }}<br>{{ config('constant.COMPANY_ADDRESS2') }}
                                        </p>
                                    </td>
                                </tr>
                            </tbody>
                    ...
                    <td>
                        <table width='100%'>
                            <tbody>
                                <tr>
                                    <td>
                                        <p><b>{{ strtoupper($transaction->d_compname) }}</b></p>
        ...
        <table cellpadding='0' cellspacing='0' width='100%' class='data'>
            <tbody class='desc'>
                ...
                @foreach ($orders as $order)
                    @php $orderno = config('constant.ORDERID_SET').$order->order_no @endphp
                    <tr>
                    ...
                    @if ($order->order_status == 2)
                        @php $receiptno = config('constant.RECEIPTID_SET').date('ymdHis',strtotime($order->order_paid_at)); @endphp
