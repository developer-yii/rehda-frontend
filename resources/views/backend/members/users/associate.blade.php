...
@section('title', 'Associate Users | List')

@section('css')
    {{-- <link rel="stylesheet" href="{{ asset('backend/assets/css/pages/associate-users.css') }}" /> --}}
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="d-flex justify-content-end">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Associate Users</li>
                </ol>
            </nav>
        </div>
        <!-- Users List Table -->
        <div class="card">
            <div class="card-header border-bottom d-flex justify-content-between">
                <h5 class="card-title mb-3">Associate Users</h5>
            </div>
            <div class="card-body">
                <div class="row mt-3">
                    <div class="col-12">
...
@section('page-js')
    <script>
        var getAssociateUsers = "{{ route('members.associateUsers') }}";
        var changePasswordUrl = "{{ route('active-members.resetPassword')}}";
        var delUserUrl = "{{ route('active-members.deleteUser') }}";
    </script>

    <script src="{{ addPageJsLink('associate-users.js?v=' . assetVersion() . time()) }}"></script>
@endsection