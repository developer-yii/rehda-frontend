                    ...
                    <form method="POST" action="" name="membertype-form">
                        ...
                        <div class="row g-3">
                            <div class="mb-3 col-md-12">
                                ...
                                <span class="error">{{ $errors->first('membertype') }}</span>
                                @endif
                            </div>
                    ...
                    <div id="subsidiary-general-information" class="content subsidiary-body">
                        ...
                        <div class="row g-3">
                            <div class="col-12 d-flex justify-content-between">
                                ...
                                <button type="button" class="btn btn-primary btn-next member-next">
                                    <span class="align-middle d-sm-inline-block d-none me-sm-1">Next</span>
                                    <i class="ti ti-arrow-right"></i>
                                </button>
                            </div>
                ...
                @csrf
                    ...
                    <div id="affiliate-official-representative-1" class="content affiliate-body">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="mb-3 col-md-12">
                                <label for="ordinaryGender-11" class="form-label form-label-lg required_label">Gender:</label>
                                <br>
                                @foreach($genders as $gender)
                                <div class="form-check-inline">
                                    <input class="form-check-input" type="radio" name="ordinaryGender-11" id="{{ $gender->gid }}" value="{{ $gender->gid }}" {{ $gender->gid == old('ordinaryGender-11') ? 'checked' : '' }}>
                                    <label class="form-check-label" for="{{ $gender->gid }}">{{ $gender->gname }}</label>
                                </div>
                                @endforeach
                                @if ($errors->has('ordinaryGender-11'))
                                <br>
                                <span class="error">{{ $errors->first('ordinaryGender-11') }}</span>
                                @endif
                            </div>
                            <div class="mb-3 col-md-12">
                                <label for="ordinaryOfficial1ProQualification" class="form-label form-label-lg">Professional Qualification (If Any)</label>
    ...
    $(document).ready(function() {
        ...
        $(".ordinary-official-representative-1-btn").on("click", function () {
            if($("#ordinaryOfficial1Title, #ordinaryOfficial1Nop, #ordinaryMyKad, #ordinaryOfficial1Designation, .ordinaryGender, #ordinaryOfficial1Email, #ordinaryOfficial1Contact, #ordinaryOfficial1Address, #ordinaryOfficial1AddressCity, #ordinaryOfficial1AddressState, #ordinaryOfficial1AddressPc, #ordinaryOfficial1AddressCountry, #ordinaryOfficial1SecretartEmail").valid()){
                ...
                // ordinaryMembershipForm.find(":input.error").first().focus();
                // console.log(ordinaryMembershipForm);
        ...
        // $(".ordinary-official-representative-1-btn").on("click", function () {
        //     if($("#ordinaryOfficial1Title, #ordinaryOfficial1Nop, #ordinaryMyKad, #ordinaryOfficial1Designation, #ordinaryOfficial1Email, #ordinaryOfficial1Contact, #ordinaryOfficial1Address, #ordinaryOfficial1AddressCity, #ordinaryOfficial1AddressState, #ordinaryOfficial1AddressPc, #ordinaryOfficial1AddressCountry, #ordinaryOfficial1SecretartEmail").valid()){
        //         stepper.next();
        //     } else {
        //         ordinaryMembershipForm.find(":input.error").first().focus();
        //     }
